...
- `create` no longer clones instances (but assumes you cloned or previously created the instance and ensures that it is destroyed on cleanup)

--------------------------------------------------------------------------------

## [0.7.0] - 2026-07-29

- Reverted `create(class)(props)` since this branch is meant for TS only
